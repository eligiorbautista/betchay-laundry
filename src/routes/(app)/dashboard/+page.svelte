...
<div class="p-4 md:p-5 lg:p-6 w-full bg-gray-50 min-h-screen">
    ...
    <div class="flex items-start sm:items-center justify-between gap-3 mb-4">
            ...
            <div class="flex items-center gap-2 md:gap-3 mb-2">
                    <LayoutDashboard class="w-7 h-7 md:w-8 md:h-8 text-blue-600" />
        ...
        <div class="lg:col-span-2 order-1">
			<div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-4 sm:p-5 md:p-6 border-b border-gray-100 flex items-start sm:items-center justify-between gap-3">
					...
					<a href="/orders" class="inline-flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors">
								...
								<div class="group border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:shadow-md transition-all duration-200">
									...
									<div class="space-y-3">
										...
										<div class="flex items-start gap-3">
											<!-- Customer Avatar -->											<div class="w-10 h-10 bg-blue-500 flex items-center justify-center text-white font-semibold text-sm rounded-lg shadow-sm flex-shrink-0">
											...
											<div class="flex-1 min-w-0">
												<div class="flex flex-col sm:flex-row sm:items-center sm:gap-2">
													<h3 class="font-semibold text-gray-900 group-hover:text-blue-900 transition-colors truncate">
														{order.customer_name}
													</h3>
										...
										<div class="flex items-center justify-end gap-2 pt-2 border-t border-gray-100 sm:hidden">
											<a 
												href="/orders/{order.id}"
												class="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-md transition-all duration-200"
											>
												<Eye class="w-3 h-3" />
												View
											</a>
			...
			<div>
				<div class="bg-white rounded-xl shadow-sm border border-gray-100">					<div class="p-4 sm:p-6 border-b border-gray-100">
					...
					<div class="p-4 sm:p-6 space-y-3">
						<a href="/orders/new" class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-blue-600 transition-all duration-200 shadow-sm hover:shadow-md">
